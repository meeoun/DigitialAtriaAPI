...
class Post extends Model implements HasMedia
{
    ...
    public static function recentImages()
    {
        ...
        $images = Media::where('collection_name','main')->latest()->take(6)->get();
        $array = Array();
        foreach ($images as $image){
            array_push($array,['small'=>$image->getUrl('dimension_85_70'),'large'=>$image->getUrl('dimension_400_430')]);
        }
...
return null;
    ...
    public function registerMediaConversions(Media $media = null): void
    {
        ...
        $conversions = array('400_430', '270_200','100_80','80_70','185_80','270_150','85_70','89_79','250_200','380_250','185_180', '330_260', '100_100', '370_270');
